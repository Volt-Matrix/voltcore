  ...
  return (
    <div className="profile-list-container">
      {profiles.map((profile, index) => (
        <div key={index} className="profile-card-new">
          <div className="top-row">
            ...
            <div className="info-top">
              ...
              <div className="info-line">{profile.employeeId}</div>
              <div className="info-line">{profile.department}</div>
            </div>
            <button className="edit-btn-top" onClick={() => handleEdit(profile)}>
              <FaUserEdit />
            </button>
          </div>
